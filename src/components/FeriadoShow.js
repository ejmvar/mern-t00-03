...
export const FeriadoShow = (props) => {
        ...
        return ( <
                ...
                noValidate className = "feriado-form"
                onSubmit = { doSubmit } >
        ...
        onChange = { doChange } >
            ...
            (errors._id) ?
            <
            p className = "field-error" > { errors._id } < /p>: < p className = "field-ok" > & nbsp; < /p >
    } <
    /td>
} <
/tr> <
...
onChange = { doChange } >
    ...
    (errors.id) ?
    <
    p className = "field-error" > { errors.id } < /p>: < p className = "field-ok" > & nbsp; < /p >
} <
/td>
} <
/tr> <
...
onChange = { doChange } >
    ...
    (errors.motivo) ?
    <
    p className = "field-error" > { errors.motivo } < /p>: < p className = "field-ok" > & nbsp; < /p >
} <
/td>
} <
/tr> <
...
onChange = { doChange } >
    ...
    (errors.tipo) ?
    <
    p className = "field-error" > { errors.tipo } < /p>: < p className = "field-ok" > & nbsp; < /p >
} <
/td>
} <
/tr> <
...
onChange = { doChange } >
    ...
    (errors.mes) ?
    <
    p className = "field-error" > { errors.mes } < /p>: < p className = "field-ok" > & nbsp; < /p >
} <
/td>
} <
/tr> <
...
onChange = { doChange } >
    ...
    (errors.dia) ?
    <
    p className = "field-error" > { errors.dia } < /p>: < p className = "field-ok" > & nbsp; < /p >
} <
/td>
} <
/tr> < /
...
p >
    ...
    button type = "submit"
onSubmit = { doSubmit }
className = "feriado__button" > Acepta < /button> <
button type = "reset"
className = "feriado__button" > Rechaza < /button> < /
    div >
