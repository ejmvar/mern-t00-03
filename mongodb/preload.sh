...
--data-raw '[
    ...
    {
        "motivo": "Feriado Puente Tur?stico",
        "tipo": "puente",
    ...
    {
        "motivo": "D?a Nacional de la Memoria por la Verdad y la Justicia",
        "tipo": "inamovible",
    ...
    {
        "motivo": "D?a del Veterano y de los Ca?dos en la Guerra de Malvinas",
        "tipo": "inamovible",
    ...
    {
        "motivo": "D?a de la Revoluci?n de Mayo",
        "tipo": "inamovible",
    ...
    {
        "motivo": "Paso a la Inmortalidad del Gral. Don Mart?n G?emes",
        "tipo": "trasladable",
        "original": "17-06",
    ...
    {
        "motivo": "D?a de la Independencia",
        "tipo": "inamovible",
    ...
    {
        "motivo": "Paso a la Inmortalidad del General Jos? de San Mart?n",
        "tipo": "trasladable",
        "original": "17-08",
    ...
    {
        "motivo": "D?a del Respeto a la Diversidad Cultural",
        "tipo": "trasladable",
        "original": "12-10",
    ...
    {
        "motivo": "D?a de la Soberan?a Nacional",
        "tipo": "trasladable",
        "original": "20-11",
    ...
    {
        "motivo": "Inmaculada Concepci?n de Mar?a",
        "tipo": "inamovible",
